...
- Implementing the real `libgemma_aml_adapter.so` around generated Amlogic code.
...
- `src/gemma_npu/` - Python package for config, manifests, export, conversion, and serving.
...
```sh
cd /home/pranavthombare/vim3-gemma-npu
make test
```
